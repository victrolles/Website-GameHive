...
for ($i = 0; $i < 3; $i++) {
    ...
    if ($pseudo == $_COOKIE["pseudo"]){
        ...
        if ($result2->num_rows > 0) {
            ...
            echo "  <p>Change to :</p>
                    <a href='php/change_badge.php?sup=$id_badge&add=40'>
                        <img class='ico' src='$default_image' alt='badge'>
                    </a>";
            ...
            while ($row2 = $result2->fetch_assoc()) {
                ...
                echo "  <a href='php/change_badge.php?sup=$id_badge&add=$id_badge2'>
                            <img class='ico' src='$image2' alt='badge'
                        </a>";
            }
        }
        echo "</div>";

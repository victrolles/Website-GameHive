...
if ($value == 'Unfriend'){
    ...
    $sql = "INSERT INTO friend (id_profil1, id_profil2, accepter) VALUES ('$id_profil', '$id_profil2', 0)";
    ...
    $sql = "UPDATE friend SET accepter = 1 WHERE id_profil1 = '$id_profil2' AND id_profil2 = '$id_profil'";
} else {

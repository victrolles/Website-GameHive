<?php
$sql = "SELECT SUBSTRING(tag, 2) AS hashtag, COUNT(*) AS count
FROM (
  SELECT DISTINCT SUBSTRING_INDEX(SUBSTRING_INDEX(texte, ' ', numbers.n), ' ', -1) AS tag
  FROM post
  CROSS JOIN (
    SELECT 1 n UNION SELECT 2 UNION SELECT 3 UNION SELECT 4 UNION SELECT 5
  ) numbers
  WHERE CHAR_LENGTH(texte) - CHAR_LENGTH(REPLACE(texte, ' ', '')) + 1 >= numbers.n
) tags
WHERE tag REGEXP '^#[a-zA-Z0-9_]+$'
GROUP BY hashtag
ORDER BY count DESC
LIMIT 3;";
    ...
    <div class="trends__container">
        <div class="trends__box">
            ...
            <div class="trends__footer">
                ...
                $sql = "SELECT PRO.id, PRO.avatar, PRO.pseudo FROM friend FRI INNER JOIN profil PRO ON FRI.id_profil1 = PRO.id WHERE id_profil2 = $id_profil_self AND FRI.accepter = 0";
        ...
        <div class="trends__box">
            ...
            <div class="trends__body">
                ...
                while($row=mysqli_fetch_assoc($result))
                {
                    ...
                    echo "<div class='decision'><a href='php/accepter.php?id=$id'><i class='fa fa-check'></i></a></div>";
                    echo "<div class='decision'><a href='php/refuser.php?id=$id'><i class='fa fa-times'></i></a></div>";
                    echo "</div>";
                    ?>
